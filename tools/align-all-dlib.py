    ...
    for imgObject in imgs:
        ...
        if os.path.isfile("aaa"):
            ...
            if rgb is None:
                ...
                print("Found {} faces", len(bbs))

                for idx,box in enumerate(bbs):
                    
                    #bl = (box.left(), box.bottom()); tr = (box.right(), box.top())
                    #cv2.rectangle(annotatedFrame, bl, tr, color=(153, 255, 204),
                    #              thickness=2)
                    print("size {}x{}".format(box.right()-box.left(), box.bottom()-box.top()))
                    ...
                    if outRgb is None and args.verbose:
                        ...
                        # salvo immaginetta
                        imgName = outputPrefix + "_" + str(idx) + ".png"
                        print("Saving img to: {}".format(imgName))
